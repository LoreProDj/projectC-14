...
function blueBalloon() {
  var blue = createSprite(0,Math.round(random(20,350)),15,15);
...
function greenBalloon() {
  var green = createSprite(0,Math.round(random(20,340)),13,13);
...
function pinkBalloon() {
  var pink = createSprite(0,Math.round(random(20,360)),14,14);
